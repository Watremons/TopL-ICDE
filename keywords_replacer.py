...
if __name__ == "__main__":
    # dataset = "1000-4241-100-3"
    # dataset = "10000-42517-1000-3"
    # dataset = "30000-127741-1000-3"
    # dataset = "50000-212790-500-3"
    # dataset = "50000-212790-800-3"
    # dataset = "50000-212790-1000-1"
    # dataset = "50000-212790-1000-2"
    # dataset = "50000-212790-1000-3"
    # dataset = "50000-212790-1000-4"
    # dataset = "50000-212790-1000-5"
    # dataset = "50000-212790-2000-3"
    dataset = "50000-212790-5000-3"
    # dataset = "100000-426096-1000-3"
    # dataset = "500000-2129290-1000-3"
    # dataset = "1000000-4259490-1000-3"
    replace_keywords(
        dataset=dataset,
        distribution="gauss"
    )
