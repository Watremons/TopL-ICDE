...
# DTopL-ICDE
python main.py -i dataset/manual/50000-145648-20-3 -d -n 2 -Q 16,3,13,10,6 -k 4 -r 2 -t 0.2 -L 5
python main.py -i dataset/manual/50000-145648-20-3/gauss -d -n 2 -Q 16,3,13,10,6 -k 4 -r 2 -t 0.2 -L 5
python main.py -i dataset/manual/50000-145648-20-3/zipf -d -n 2 -Q 16,3,13,10,6 -k 4 -r 2 -t 0.2 -L 5
